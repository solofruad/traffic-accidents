...
brief_cleaning = (preText(str(row)) for row in X_test)
txt = [clean_fn(doc) for doc in nlp.pipe(brief_cleaning, n_threads=-1)]

test['text'] = txt

train.to_csv("data/v1/7030/train70clean.tsv",sep='\t')
test.to_csv("data/v1/7030/test30clean.tsv",sep='\t')
...
arr = pd.read_csv("test30beto.csv")
...
train = pd.read_csv("data/v1/7030/train70beto.csv")
test = pd.read_csv("data/v1/7030/test30beto.csv")
